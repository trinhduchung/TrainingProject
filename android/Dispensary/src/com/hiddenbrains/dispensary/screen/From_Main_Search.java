...
public class From_Main_Search extends Activity implements OnClickListener, Runnable{
...
//			bundle.putString("address",address.get(0).toString());
	...
	private Handler handler = new Handler() 
	{
	      ...
	      {   
	    	  ...
	    	  lzm = new LazyAdapterMainList(From_Main_Search.this,title,distance,image,imageUrl,address,icon_image);
	          try
	          {
	        	  list.setAdapter(lzm);
	          }
